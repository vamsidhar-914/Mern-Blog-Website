    ...
    <div className='flex p-4 border-b dark:border-gray-600 text-sm'>
      ...
      <div className='flex-1'>
        ...
        {isEditing ? (
          ...
          <><p className='text-gray-500 pb-2'>{comment.content}</p><div className='flex items-center pt-3 text-xs border-t dark;border-gray-700 max-w-fit gap-2'>
              ...
              {currentUser && (currentUser._id === comment.userId || currentUser.isAdmin) && (
                <>
                <button type='button' className='text-gray-400 hover:text-green-500' onClick={handleEdit}>
                  Edit
                </button>
